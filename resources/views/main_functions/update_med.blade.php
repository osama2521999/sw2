...
@section('navbar')
	...
	<li class="nav-item active"><a href="update_med" class="nav-link">Update medicine</a></li>
...
.card-1 .card-heading {
  background: url("images/ut1.jpg") center center/cover no-repeat;
  padding-top: 210px;
}
...
@media (max-width: 767px) {
 ...
 <div class="page-wrapper bg-gra-02 p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                <div class="card-heading"></div>
                <div class="card-body">
                    <h2 class="title">Update Medicine</h2>
                    <form action="update_med" method="POST">
                      ...
                      @csrf
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Add medicine New Name" name="n_name">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Add medicine New Quantity" name="Quantity">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Add medicine New Year" name="year">
                        </div>
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--blue" type="submit">Update</button>
                        </div>
                    </form>
                    <div class="name">
                                                @if(count($errors)>0)
