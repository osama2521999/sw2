                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="n_name" placeholder ="Add medicine Name">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="name">Expire year</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="year" placeholder ="Add medicine Year">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="int" name="price" placeholder ="Add medicine $Price">
                                </div>
                            </div>
                        </div>
                        <div>
