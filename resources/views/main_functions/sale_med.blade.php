...
.card-1 .card-heading {
  background: url("images/t4.jpg") center center/cover no-repeat;
  padding-top: 210px;
}
                ...
                <div class="card-body">
                    ...
                    <form action="sale_med" method="POST">
                      ...
                      @csrf
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Add Order Quantity" name="Quantity">
                        </div>
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" type="submit">Sale</button>
                        </div>
                    </form>
                    <div class="name">
                                                @if(count($errors)>0)
