                ...
                <div class="card-body">
                    ...
                    <form action="add_med" method="POST">
                      ...
                      @csrf
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Add medicine Name" name="name">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Add medicine Quantity" name="Quantity">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Add medicine Year" name="year">
                        </div>
